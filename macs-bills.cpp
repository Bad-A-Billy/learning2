...
INPUT_PORTS_START( macsbio1 )
	PORT_INCLUDE( macs_m )
INPUT_PORTS_END


INPUT_PORTS_START( macsbio2 )
	PORT_INCLUDE( macs_m )
INPUT_PORTS_END


INPUT_PORTS_START( cultname )
	// MAHJONG PANEL
	PORT_START("IN0")
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_MAHJONG_LAST_CHANCE )
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_MAHJONG_SCORE )
	...
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_MAHJONG_BIG )
	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_MAHJONG_SMALL )
	PORT_BIT( 0xc0, IP_ACTIVE_LOW, IPT_BUTTON1 )
	...
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_MAHJONG_KAN )
	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_START1 )
	PORT_BIT( 0xc0, IP_ACTIVE_LOW, IPT_BUTTON2 )
	...
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_MAHJONG_REACH )
	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_MAHJONG_BET )
	PORT_BIT( 0xc0, IP_ACTIVE_LOW, IPT_BUTTON3 )
	...
	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_MAHJONG_CHI )
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_MAHJONG_RON )
	PORT_BIT( 0xe0, IP_ACTIVE_LOW, IPT_BUTTON4 )
	...
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_MAHJONG_L )
	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_MAHJONG_PON )
	PORT_BIT( 0xf0, IP_ACTIVE_LOW, IPT_BUTTON5 )

	PORT_START("DSW0")
	PORT_DIPNAME( 0x01, 0x01, "Coinage" )
	PORT_DIPSETTING(    0x01, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x02, 0x02, "DSW0 - BIT 2" )
	PORT_DIPSETTING(    0x02, DEF_STR( Off ) )
	...
	PORT_DIPSETTING(    0x04, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x08, 0x08, "Adult Theme" )
	PORT_DIPSETTING(    0x08, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x10, 0x10, "1P / 2P Game ?" )
	PORT_DIPSETTING(    0x10, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x20, 0x20, "DSW0 - BIT 20" )
	PORT_DIPSETTING(    0x20, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x40, 0x40, "Service ?" )
	PORT_DIPSETTING(    0x40, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
//	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_SERVICE1 )
	...
	PORT_DIPSETTING(    0x02, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x04, 0x04, "DSW3 - BIT 4" )
	PORT_DIPSETTING(    0x04, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x08, 0x08, "DSW 3 - Bit 8" )
	PORT_DIPSETTING(    0x08, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x10, 0x10, "DSW 3 - Bit 10" )
	PORT_DIPSETTING(    0x00, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x10, DEF_STR( On ) )
	PORT_DIPNAME( 0x20, 0x20, "DSW 3 - Bit 20" )
	PORT_DIPSETTING(    0x20, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x40, 0x40, "DSW 3 - Bit 40" )
	PORT_DIPSETTING(    0x40, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x80, 0x80, "DSW 3 - Bit 80" )
	PORT_DIPSETTING(    0x80, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	...
	PORT_START("SYS0")
	PORT_BIT( 0x7f, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_OTHER ) PORT_NAME("Key In") PORT_CODE(KEYCODE_4_PAD)

	PORT_START("SYS1")
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 )
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_OTHER ) PORT_NAME("Clear Coin Counter") PORT_CODE(KEYCODE_1_PAD)
//	PORT_BIT( 0x03, IP_ACTIVE_LOW, IPT_OTHER ) PORT_NAME("Key 4") PORT_CODE(KEYCODE_4_PAD)
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_MEMORY_RESET ) PORT_CODE(KEYCODE_2_PAD)
//	PORT_BIT( 0x05, IP_ACTIVE_LOW, IPT_OTHER ) PORT_NAME("Key 5") PORT_CODE(KEYCODE_5_PAD)
//	PORT_BIT( 0x06, IP_ACTIVE_LOW, IPT_OTHER ) PORT_NAME("Key 6") PORT_CODE(KEYCODE_6_PAD)
//	PORT_BIT( 0x07, IP_ACTIVE_LOW, IPT_OTHER ) PORT_NAME("Key 7") PORT_CODE(KEYCODE_7_PAD)
	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_OTHER ) PORT_NAME("Analyzer Key") PORT_CODE(KEYCODE_3_PAD)
	PORT_BIT( 0xf0, IP_ACTIVE_LOW, IPT_UNUSED )
INPUT_PORTS_END


INPUT_PORTS_START( kisekaeh )
	PORT_INCLUDE( macs_h )
...
//	PORT_INCLUDE( macs_m )
	...
	PORT_START("DSW0")
	PORT_DIPNAME( 0x07, 0x07, "Coin Settings" )     PORT_DIPLOCATION("DSW0:1,2,3")
	...
	PORT_DIPNAME( 0x18, 0x08, "Note Settings" )     PORT_DIPLOCATION("DSW0:4,5")
	PORT_DIPSETTING(    0x00, "1 Note = 10 Credits" )
	PORT_DIPSETTING(    0x08, "1 Note = 5 Credits" )
	PORT_DIPSETTING(    0x10, "1 Note = 2 Credits" )
	PORT_DIPSETTING(    0x18, "1 Note = 1 Credit" )
	PORT_DIPNAME( 0x60, 0x20, "Credit Limit" )      PORT_DIPLOCATION("DSW0:6,7")
	PORT_DIPSETTING(    0x00, "60,000" )
	PORT_DIPSETTING(    0x20, "50,000" )
	PORT_DIPSETTING(    0x40, "30,000" )
	PORT_DIPSETTING(    0x60, "10,000" )
	PORT_DIPNAME( 0x80, 0x80, "BET Screen Timer" )  PORT_DIPLOCATION("DSW0:8")
	PORT_DIPSETTING(    0x80, "Yes" )
	PORT_DIPSETTING(    0x00, "No" )

	PORT_START("DSW1")
	PORT_DIPNAME( 0x07, 0x05, "Payout %" )          PORT_DIPLOCATION("DSW1:1,2,3")
	...
	PORT_DIPNAME( 0x08, 0x08, "Wave Of Refund" )    PORT_DIPLOCATION("DSW1:4")
	PORT_DIPSETTING(    0x08, "Large" )
	PORT_DIPSETTING(    0x00, "Small" )
	PORT_DIPNAME( 0x30, 0x20, "Minimum Bets" )      PORT_DIPLOCATION("DSW1:5,6")
	PORT_DIPSETTING(    0x00, "5" )
	PORT_DIPSETTING(    0x10, "3" )
	PORT_DIPSETTING(    0x20, "2" )
	PORT_DIPSETTING(    0x30, "1" )
	PORT_DIPNAME( 0xc0, 0x00, "Maximum Bets" )      PORT_DIPLOCATION("DSW1:7,8")
	...
	PORT_START("DSW2")
	PORT_DIPNAME( 0x03, 0x02, "# of Cancels" )      PORT_DIPLOCATION("DSW2:1,2")
	PORT_DIPSETTING(    0x00, "0" )
	PORT_DIPSETTING(    0x01, "1" )
	PORT_DIPSETTING(    0x02, "3" )
	PORT_DIPSETTING(    0x03, "99" )
	PORT_DIPNAME( 0x04, 0x04, "Cancel Cost" )       PORT_DIPLOCATION("DSW2:3")
	PORT_DIPSETTING(    0x04, "Free" )
	PORT_DIPSETTING(    0x00, "Fee" )
	PORT_DIPNAME( 0x18, 0x10, "# of Last Chances" ) PORT_DIPLOCATION("DSW2:4,5")
	PORT_DIPSETTING(    0x00, "0" )
	PORT_DIPSETTING(    0x08, "1" )
	PORT_DIPSETTING(    0x10, "3" )
	PORT_DIPSETTING(    0x18, "5" )
	PORT_DIPNAME( 0x20, 0x20, "Last Chance Cost" )  PORT_DIPLOCATION("DSW2:6")
	PORT_DIPSETTING(    0x20, "Free" )
	PORT_DIPSETTING(    0x00, "Fee" )
	PORT_DIPNAME( 0x40, 0x00, "Double Up Game" )    PORT_DIPLOCATION("DSW2:7")
	PORT_DIPSETTING(    0x40, DEF_STR( On ) )
	PORT_DIPSETTING(    0x00, DEF_STR( Off ) )
	PORT_DIPNAME( 0x80, 0x80, "Double Up - EVEN" )  PORT_DIPLOCATION("DSW2:8")
	PORT_DIPSETTING(    0x80, "Split Winnings" )
	PORT_DIPSETTING(    0x00, "Lose Winnings" )

	PORT_START("DSW3")
	PORT_DIPNAME( 0x01, 0x01, "Screen Inversion" )  PORT_DIPLOCATION("DSW3:1")
	PORT_DIPSETTING(    0x01, "Normal" )
	PORT_DIPSETTING(    0x00, "Inverted" )
	PORT_DIPNAME( 0x02, 0x00, "Auto Tsumi After Reach" ) PORT_DIPLOCATION("DSW3:2,")
	PORT_DIPSETTING(    0x02, DEF_STR( On ) )
	PORT_DIPSETTING(    0x00, DEF_STR( Off ) )
	PORT_DIPNAME( 0x04, 0x00, DEF_STR( Demo_Sounds ) )   PORT_DIPLOCATION("DSW3:3")
	PORT_DIPSETTING(    0x04, DEF_STR( On ) )
	PORT_DIPSETTING(    0x00, DEF_STR( Off ) )
	PORT_DIPNAME( 0x08, 0x08, "Game Type" )          PORT_DIPLOCATION("DSW3:4")
	PORT_DIPSETTING(    0x08, "Bet" )
	PORT_DIPSETTING(    0x00, "Points" )
	PORT_DIPNAME( 0x10, 0x00, "Map / Level Select" ) PORT_DIPLOCATION("DSW3:5")
	PORT_DIPSETTING(    0x10, DEF_STR( On ) )
	PORT_DIPSETTING(    0x00, DEF_STR( Off ) )
	PORT_DIPNAME( 0x20, 0x20, "Memory Reset" )       PORT_DIPLOCATION("DSW3:6")
	PORT_DIPSETTING(    0x20, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x40, 0x40, "Analyzer" )           PORT_DIPLOCATION("DSW3:7")
	PORT_DIPSETTING(    0x40, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x80, 0x80, "Test Mode" )          PORT_DIPLOCATION("DSW3:8")
	PORT_DIPSETTING(    0x80, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	...
	PORT_START("SYS0")
	PORT_BIT( 0x7f, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_OTHER ) PORT_NAME("Note Key-In") PORT_CODE(KEYCODE_4_PAD)

	PORT_START("SYS1")
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 )
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_OTHER ) PORT_NAME("Clear Coin Counter") PORT_CODE(KEYCODE_1_PAD)
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_MEMORY_RESET ) PORT_CODE(KEYCODE_2_PAD)
	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_OTHER ) PORT_NAME("Analyzer Key") PORT_CODE(KEYCODE_3_PAD) PORT_TOGGLE
	PORT_BIT( 0xf0, IP_ACTIVE_LOW, IPT_UNUSED )
INPUT_PORTS_END


INPUT_PORTS_START( yuka )
	PORT_INCLUDE( macs_h )
INPUT_PORTS_END
...
GAME( 1995, macsbios, 0,        macs, macsbio1, macs_state, init_macs,     ROT0, "I'Max",            "Multi Amenity Cassette System BIOS",   MACHINE_IS_BIOS_ROOT | MACHINE_IMPERFECT_SOUND | MACHINE_NOT_WORKING )
GAME( 1995, mac2bios, 0,        macs, macsbio2, macs_state, init_macs2,    ROT0, "I'Max",            "Multi Amenity Cassette System 2 BIOS", MACHINE_IS_BIOS_ROOT | MACHINE_IMPERFECT_SOUND | MACHINE_NOT_WORKING )
...
GAME( 1995, kisekaeh, macsbios, macs, kisekaeh, macs_state, init_kisekaeh, ROT0, "I'Max",            "Kisekae Hanafuda",                     MACHINE_NOT_WORKING | MACHINE_IMPERFECT_SOUND )
GAME( 1996, cultname, macsbios, macs, cultname, macs_state, init_macs,     ROT0, "I'Max",            "Seimei-Kantei-Meimei-Ki Cult Name",    MACHINE_NOT_WORKING | MACHINE_IMPERFECT_SOUND )
GAME( 1999, yujan,    macsbios, macs, yujan,    macs_state, init_macs2,    ROT0, "Yubis / T.System", "Yu-Jan",                               0 )
GAME( 1999, yuka,     macsbios, macs, yuka,     macs_state, init_macs2,    ROT0, "Yubis / T.System", "Yu-Ka",                                0 )
